        ...
        <div className="space-y-4">
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0">
              <p className="text-[11px] font-semibold uppercase tracking-[0.08em] text-sky-700">Source editor</p>
              <div className="mt-2 flex min-w-0 items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-sm text-slate-500">Use this editor as the sync source for every target below.</p>
                </div>
              </div>
            </div>
            <Badge variant={BADGE_VARIANT.INFO}>Source</Badge>
          </div>
          <div className="grid grid-cols-3 gap-2">
            <div className="rounded-lg border border-sky-100 bg-white/80 px-3 py-2">
              <p className="text-[11px] font-medium text-slate-500">Installed</p>
              <p className="mt-1 text-lg font-semibold text-slate-950">{installedCount}</p>
            </div>
            <div className="rounded-lg border border-sky-100 bg-white/80 px-3 py-2">
              <p className="text-[11px] font-medium text-slate-500">Compared</p>
              <p className="mt-1 text-lg font-semibold text-slate-950">{targetCount}</p>
            </div>
            <div className="rounded-lg border border-sky-100 bg-white/80 px-3 py-2">
              <p className="text-[11px] font-medium text-slate-500">Missing copies</p>
        ...
        <div className="overflow-hidden rounded-lg border border-sky-100 bg-white/80">
          <div className="border-b border-sky-100 px-4 py-3">
            <div className="flex items-center justify-between gap-3">
              <div>
                <h4 className="text-sm font-semibold text-slate-900">Installed extensions</h4>
                <p className="text-xs text-slate-500">Preview of the source inventory used for sync comparisons.</p>
              </div>
              <span className="text-xs font-medium text-slate-400">{installedExtensions.length} total</span>
            </div>
          </div>
          ...
          <div className="max-h-64 overflow-y-auto px-3 py-2">
            {installedExtensions.length > 0 ? (
              ...
              <div className="px-3 py-8 text-center text-sm text-slate-500">No extensions detected.</div>
            )}
          </div>
        </div>
      </div>
