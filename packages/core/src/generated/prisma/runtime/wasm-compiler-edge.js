  ...
  co = xe(() => {
    ...
    C.toSignificantDigits = C.tosd = function (e, t) {
      var r = this,
        n = r.constructor;
      return (
        e === void 0 ? ((e = n.precision), (t = n.rounding)) : (Te(e, 1, at), t === void 0 ? (t = n.rounding) : Te(t, 0, 8)),
        _(new n(r), e, t)
      );
    };
    C.toString =
...
var Id = 128,
  ...
  Rt;
function kd(e) {
  (!et || et.length < e ? ((et = g.allocUnsafe(e * Id)), Vt.getRandomValues(et), (Rt = 0)) : Rt + e > et.length && (Vt.getRandomValues(et), (Rt = 0)),
    (Rt += e));
}
function hi(e = 21) {
  kd((e |= 0));
