...
const variantClassName: Record<ButtonVariant, string> = {
  ...
  [BUTTON_VARIANT.GHOST]: "text-slate-500 hover:bg-slate-100 hover:text-slate-700 active:bg-slate-200/70 disabled:text-slate-300"
};
...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(function Button(
  { className, variant = BUTTON_VARIANT.PRIMARY, size = BUTTON_SIZE.MD, leadingIcon, trailingIcon, children, type = "button", ...props },
  ref
) {
  return (
    <button
